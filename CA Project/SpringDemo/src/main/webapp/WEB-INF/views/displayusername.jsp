...
<div id="wrapper">
 ...
 <li >
                    ...
                    <li class="active-link">
					 ...
					 <li class="active-link">
                        <a href="displayusername"><i class="fa fa-edit "></i>Display Document </a>
                    </li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Display Client Document </h2>   
                     <form action="displaydocument" method="post">
  <div class="form-group">
    <label for="exampleFormControlInput1">Client Name</label>
     <select name="name" class="form-control">  
       <option value="--Select Employee-------">Select Client Name</option>   
