...
<li >
  ...
  <div class="form-group">
    <label for="exampleFormControlSelect1">Estimated Completion Date</label>
    <input type="date" name="date" class="form-control" id="exampleFormControlSelect1">
  
  </div>
  <div class="form-group">
    <label for="exampleFormControlSelect2">Estimated completion Time</label>
    <input type="time" name="time" multiple class="form-control" id="exampleFormControlSelect2">
  </div>
  <div class="form-group">
    <label for="exampleFormControlTextarea1">Assign Task</label>
    <textarea class="form-control" name="task" id="exampleFormControlTextarea1" rows="6"></textarea>
  </div>
