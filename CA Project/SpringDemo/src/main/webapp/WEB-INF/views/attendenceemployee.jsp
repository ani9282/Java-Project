...
<title>Attendees Of Employee</title>
 <meta charset="utf-8" />
   ...
   <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
    <script>
   function foo() {
	   alert("You have Successfully done Atttendence Of Employee");
	   return true;
	}
   </script>
</head>
...
<!--  
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Attendees Of Employee </h2>   
                       <form action="saveattendenceofemployee" method="post">
  <div class="form-group">
    <label for="exampleFormControlInput1">Employee Name</label>
     <select name="name" class="form-control">  
       <option value="--Select Employee-------">Select Employee</option>   
   <c:forEach var="j" items="${addItem}">
  ...
  <div class="form-group">
    ...
    <input type="date" name="date" multiple class="form-control" id="exampleFormControlSelect2">
  </div>
  
  <div class="form-group">
    <label for="exampleFormControlSelect2">Attendence OF Employee</label><br>
   <input type="radio" id="male" name="attendence" value="Present"> Present &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   <input type="radio" id="male" name="attendence" value="Absent"> Absent
  </div>
