...
<!--  
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Attendence From Date To Date  </h2>   
                       <form action="datewiseattendence" method="post">
  ...
  <div class="form-group">
    <label for="exampleFormControlSelect2">From Date</label>
    <input type="date" name="fromdate" multiple class="form-control" id="exampleFormControlSelect2">
  </div>
  
  <div class="form-group">
    <label for="exampleFormControlSelect2">To Date</label>
    <input type="date" name="todate" multiple class="form-control" id="exampleFormControlSelect2">
  </div>
  ...
  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    <input type="submit" value="Submit" style="background-color: #008CBA; padding: 10px 250px;" ">
